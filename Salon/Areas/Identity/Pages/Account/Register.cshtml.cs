...
namespace Salon.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        {
            [Required]
            public string PhoneNumber { get; set; } // شماره تلفن به‌عنوان ورودی ضروری
        ...
        public async Task OnGetAsync(string returnUrl = null)
        {
            if   (  !_roleManager.RoleExistsAsync(Sd.Role_Customer).GetAwaiter().GetResult())
            {
                ...
                _roleManager.CreateAsync(new IdentityRole(Sd.Role__Staff)).GetAwaiter().GetResult();
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            {
                var user = CreateUser();
                // تنظیم شماره تلفن به‌جای ایمیل برای نام کاربری
